...
<Steps>
  <Step>
    ...
    You can also copy the [Nunjucks templates](https://github.com/hunvreus/basecoat/tree/main/src/nunjucks) or [Jinja templates](https://github.com/hunvreus/basecoat/tree/main/src/jinja) from GitHub.
  </Step>
  <Step>
    ### Use a Macro
