...
<div class="scrollbar h-72 w-full max-w-sm overflow-y-auto rounded-md border p-4">
  <div class="space-y-4">
...
Use `scrollbar` or `scrollbar-thin` on an element that already scrolls with `overflow-auto`, `overflow-y-auto`, or `overflow-x-auto`.
...
Use `scrollbar-thin` for compact scrollable regions like menus, listboxes, sidebars, and command results.
...
<div class="w-full max-w-sm rounded-md border p-1">
  ...
  <div class="scrollbar-thin max-h-48 overflow-y-auto">
...
<Preview class="w-full">
<div dir="rtl" class="scrollbar h-72 w-full max-w-sm overflow-y-auto rounded-md border p-4">
  <div class="space-y-4">
