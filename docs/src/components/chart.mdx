import chartExamplesUrl from "../site/chart-examples.js?url"

# Chart

<Callout type="warning" title="Alpha API" icon="triangle-alert">
  Chart support is alpha. The JavaScript API, generated markup, and option names may change before the stable 1.0 release.
</Callout>
...
<script src="https://cdn.jsdelivr.net/npm/basecoat-css@1.0.0-beta.4/dist/js/chart.min.js" defer></script>
```
...
<script type="module" src={chartExamplesUrl}></script>
