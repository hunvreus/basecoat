...
<div class="field">
  <div class="flex items-center gap-3">
    ...
    <output class="text-muted-foreground ms-auto text-sm tabular-nums">66%</output>
  </div>
...
<Preview class="w-full max-w-sm">
<div dir="rtl" class="progress" role="progressbar" aria-label="تحميل" aria-valuenow="66" aria-valuemin="0" aria-valuemax="100">
  <span style="width: 66%"></span>
</div>
</Preview>
