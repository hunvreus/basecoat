...
<div id="dropdown-checkboxes" class="dropdown-menu">
  ...
  <div id="dropdown-checkboxes-popover" data-popover aria-hidden="true" class="min-w-32">
...
<div id="dropdown-destructive" class="dropdown-menu">
  <button type="button" id="dropdown-destructive-trigger" aria-haspopup="menu" aria-controls="dropdown-destructive-menu" aria-expanded="false" class="btn" data-variant="outline">Open</button>
...
<div dir="rtl">
  <div id="dropdown-rtl" class="dropdown-menu">
    <button type="button" id="dropdown-rtl-trigger" aria-haspopup="menu" aria-controls="dropdown-rtl-menu" aria-expanded="false" class="btn" data-variant="outline">فتح</button>
    <div id="dropdown-rtl-popover" data-popover aria-hidden="true" class="min-w-32" data-align="end">
