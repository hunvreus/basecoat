...
<div id="demo-command-standalone" class="command border" aria-label="Command menu">
  ...
  <div role="menu" id="demo-command-standalone-menu" aria-orientation="vertical" data-empty="No results found." class="scrollbar-sm">
...
<script src="https://cdn.jsdelivr.net/npm/basecoat-css@1.0.0-beta.4/dist/js/command.min.js" defer></script>
```
...
<dialog id="command-basic" class="command-dialog" aria-label="Command menu" onclick="if (event.target === this) this.close()">
  <div class="command">
    ...
    <div role="menu" id="command-basic-menu" aria-orientation="vertical" data-empty="No results found." class="scrollbar-sm">
...
<div id="command-shortcuts" class="command border" aria-label="Command menu">
  ...
  <div role="menu" id="command-shortcuts-menu" aria-orientation="vertical" data-empty="No results found." class="scrollbar-sm">
...
<div id="command-groups" class="command border" aria-label="Command menu">
  ...
  <div role="menu" id="command-groups-menu" aria-orientation="vertical" data-empty="No results found." class="scrollbar-sm">
...
<div id="command-scrollable" class="command border" aria-label="Command menu">
  ...
  <div role="menu" id="command-scrollable-menu" aria-orientation="vertical" data-empty="No results found." class="scrollbar-sm">
...
<div dir="rtl">
  <div id="command-rtl" class="command border" aria-label="Command menu">
    ...
    <div role="menu" id="command-rtl-menu" aria-orientation="vertical" data-empty="No results found." class="scrollbar-sm">
