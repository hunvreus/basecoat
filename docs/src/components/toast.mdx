...
<Callout title="Template macros available" icon="code" action={{ label: "Read more", href: "/cli#toast" }}>
...
<script src="https://cdn.jsdelivr.net/npm/basecoat-css@1.0.0-beta.2/dist/js/toast.min.js" defer></script>
```
...
<dl>
  <dt><code class="highlight language-html">&lt;div id="toaster" class="toaster"&gt;</code></dt>
