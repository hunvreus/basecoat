  ...
  <div class="sm:max-w-md">
    ...
    <section class="flex items-center gap-2">
      <div class="grid flex-1 gap-2">
        ...
        <input class="input" id="dialog-custom-close-link" value="https://ui.shadcn.com/docs/installation" readonly />
      </div>
    </section>
...
<Preview>
<div dir="rtl">
  <button type="button" onclick="document.getElementById('dialog-rtl').showModal()" class="btn" data-variant="outline">فتح</button>
