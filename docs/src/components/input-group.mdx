...
<div class="grid gap-6">
  ...
  <div class="input-group min-h-32" data-orientation="vertical">
    ...
    <footer data-align="end" role="group" aria-label="Message actions">
      ...
      <div id="dropdown-menu-670915" class="dropdown-menu min-w-0">
        <button type="button" id="dropdown-menu-670915-trigger" aria-haspopup="menu" aria-controls="dropdown-menu-670915-menu" aria-expanded="false" class="btn-xs-ghost">Auto</button>
        <div id="dropdown-menu-670915-popover" data-popover aria-hidden="true" data-side="top" data-align="start" class="min-w-28 [--radius:0.95rem]">
          <div role="menu" id="dropdown-menu-670915-menu" aria-labelledby="dropdown-menu-670915-trigger">
            <div id="dropdown-menu-670915-items-1" role="menuitem">Auto</div>
            <div id="dropdown-menu-670915-items-2" role="menuitem">Agent</div>
            <div id="dropdown-menu-670915-items-3" role="menuitem">Manual</div>
          </div>
        </div>
      </div>
  ...
  <div class="input-group">
    ...
    <span data-align="end" aria-hidden="true">
      <span class="flex size-4 items-center justify-center rounded-full bg-primary text-primary-foreground">
        <svg class="size-3 lucide lucide-check" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 6 9 17l-5-5" /></svg>
      </span>
    </span>
  </div>
</div>
...
Use `.input-group` on the root. Native controls stay semantic and become borderless children inside that shell.
...
<div class="field max-w-sm">
  ...
  <div class="input-group">
    ...
    <span role="group" data-align="start" aria-hidden="true">
      <svg class="text-muted-foreground lucide lucide-search" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m21 21-4.34-4.34" /><circle cx="11" cy="11" r="8" /></svg>
    </span>
  </div>
...
<div class="grid gap-6">
  ...
  <div class="input-group">
    <input type="text" placeholder="Card number" />
    <span data-align="end" aria-hidden="true">
      <svg class="lucide lucide-star" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M11.525 2.295a.53.53 0 0 1 .95 0l2.31 4.679a2.123 2.123 0 0 0 1.595 1.16l5.166.756a.53.53 0 0 1 .294.904l-3.736 3.638a2.123 2.123 0 0 0-.611 1.878l.882 5.14a.53.53 0 0 1-.771.56l-4.618-2.428a2.122 2.122 0 0 0-1.973 0L6.396 21.01a.53.53 0 0 1-.77-.56l.881-5.139a2.122 2.122 0 0 0-.611-1.879L2.16 9.795a.53.53 0 0 1 .294-.906l5.165-.755a2.122 2.122 0 0 0 1.597-1.16z" /></svg>
      <svg class="lucide lucide-info" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10" /><path d="M12 16v-4" /><path d="M12 8h.01" /></svg>
    </span>
  </div>
</div>
...
<div class="grid gap-6">
  <div class="input-group">
    ...
    <div id="dropdown-menu-601971" class="dropdown-menu" data-align="end">
      <button type="button" id="dropdown-menu-601971-trigger" aria-haspopup="menu" aria-controls="dropdown-menu-601971-menu" aria-expanded="false" class="btn-xs-icon-ghost" aria-label="Open file actions">
  ...
  <div class="input-group [--radius:1rem]">
    ...
    <div id="dropdown-menu-689868" class="dropdown-menu" data-align="end">
      <button type="button" id="dropdown-menu-689868-trigger" aria-haspopup="menu" aria-controls="dropdown-menu-689868-menu" aria-expanded="false" class="btn-xs-ghost pr-1.5! text-xs">
        Search In...
