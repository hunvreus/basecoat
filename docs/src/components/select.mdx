...
<script src="https://cdn.jsdelivr.net/npm/basecoat-css@1.0.0-beta.3/dist/js/select.min.js" defer></script>
```
...
<div id="select-679828" class="select" data-placeholder="Select an item...">
  ...
  <div id="select-679828-popover" data-popover aria-hidden="true">
    <div role="listbox" id="select-679828-listbox" aria-orientation="vertical" aria-labelledby="select-679828-trigger" class="scrollbar-thin overflow-y-auto max-h-64">
