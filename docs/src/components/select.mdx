...
<script src="https://cdn.jsdelivr.net/npm/basecoat-css@1.0.0-beta.2/dist/js/select.min.js" defer></script>
```
        ...
        <dl>
          ...
          <dd>
            ...
            <dl>
              ...
              <dd>Selectable option. Use <code>data-label</code> when selected text should differ from rendered content.</dd>
...
<div class="flex flex-wrap gap-3">
  <div id="select-align-start" class="select">
    ...
    <div id="select-align-start-popover" data-popover aria-hidden="true" data-align="start">
  ...
  <div id="select-align-end" class="select">
    ...
    <div id="select-align-end-popover" data-popover aria-hidden="true" data-align="end">
...
<Preview>
<div id="select-groups" class="select">
...
<Preview>
<div id="select-679828" class="select">
  <button type="button" class="" id="select-679828-trigger" aria-haspopup="listbox" aria-expanded="false" aria-controls="select-679828-listbox">
    <span class="truncate"></span>
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevron-down-icon lucide-chevron-down text-muted-foreground opacity-50 shrink-0"><path d="m6 9 6 6 6-6" /></svg>
  </button>
  ...
  <input type="hidden" name="select-679828-value" value="" />
</div>
</Preview>
...
<div id="select-877925" class="select">
  <button type="button" class="" id="select-877925-trigger" aria-haspopup="listbox" aria-expanded="false" aria-controls="select-877925-listbox" disabled="disabled">
    <span class="truncate"></span>
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevron-down-icon lucide-chevron-down text-muted-foreground opacity-50 shrink-0"><path d="m6 9 6 6 6-6" /></svg>
  </button>
  ...
  <input type="hidden" name="select-877925-value" value="" />
</div>
</Preview>
