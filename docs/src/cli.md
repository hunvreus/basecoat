...
title: CLI
description: Use the Basecoat CLI and template macros.
...
<div class="prose">
  ...
  <p>To install them, either <a href="https://github.com/hunvreus/basecoat/tree/main/src" target="_blank">copy them directly from the GitHub repository</a> or use <a href="#cli">the CLI</a>.</p>
